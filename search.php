...
<body>
  <nav class="navbar navbar-inverse navbar-fixed-top">
	...
	$search = $_POST["search"];
	$sql = "select * from eco where NAME = '$search'";
      ...
      while ($row = $result->fetch_object()){
          ?>
            ...
            <div class="col-md-4" align="center">
              ...
              <a href="#" data-toggle="modal" data-target="#LogIn1" data-whatever="@mdo">
                <img height="400" width="500" src="img\<?=$row->IMAGE ?>">
              </a>
              <h3 style="background-color: black; color: white">Price : <?=$row->Prince?>$</h3><br><hr>
    		    ...
    		    <form enctype="multipart/form-data" name="registerForm" method="post" action="payment.php">
    		      <div class="modal fade" id="LogIn1" tabindex="-1" role="dialog" aria-labelledby="LogInLabel" aria-hidden="true">
    		        <div class="modal-dialog" role="document">
